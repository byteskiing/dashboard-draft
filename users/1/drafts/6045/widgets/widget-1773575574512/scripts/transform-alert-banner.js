...
// Use translucent severity tints so the banner stays readable on both dark and
// light dashboard chrome instead of forcing a pale light surface.
const topLevel   = sorted[0]?.level ?? 'info';
const levelColor = topLevel === 'critical' ? '#DC2626' : topLevel === 'warning' ? '#D97706' : '#3B82F6';
const levelBg    = topLevel === 'critical' ? 'rgba(220,38,38,0.12)' : topLevel === 'warning' ? 'rgba(217,119,6,0.12)' : 'rgba(59,130,246,0.12)';
